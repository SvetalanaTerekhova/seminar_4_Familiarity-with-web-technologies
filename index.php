...
$phone = "122554";
$skills = [];
$skills[0] = ["name" => "Photoshop", "persent" => 60];
$skills[1] = ["name" => "blender", "persent" => 80];
$skills[2] = ["name" => "FineRider", "persent" => 90];
$skills[3] = ["name" => "SAP", "persent" => 75];
$workExperience =
[
    [
     	'name' => 'Дизайнер',
        'startDate' => 'Декабря 2021',
        'endDate' => 'по настоящее время',
        'experience' => 'Специалист по бухгалтерскому учёту, работающий по системе учёта в соответствии с действующим законодательством.',
    ],
    [
        'name' => 'Финансовый директор',
        'startDate' => 'Марта 2018',
        'endDate' => 'Сентябрь 2021',
        'experience' => 'Определяет финансовую политику организации, разрабатывает и осуществляет меры по обеспечению её финансовой устойчивости. Руководит работой по управлению финансами исходя из стратегических целей и перспектив развития организации',
    ],
    [
        'name' => 'Экономист',
        'startDate' => 'Февраль 2017',
        'endDate' => 'Март 2018',
        'experience' => 'Специалист в экономике или её разделах, эксперт по экономическим вопросам промышленности, сельского хозяйства, банковского дела и так далее.',
    ],
    [
        'name' => 'Бухгалтер',
        'startDate' => 'Май 2010',
